...
DOTFILES=(.gitconfig .gitignore_global .vimrc .zshrc .tmux.conf .config/starship.toml .config/containers/containers.conf .config/foot/foot.ini .config/mako/config .config/gammastep/config.ini .local/share/com.pais.handy/settings_store.json)
