...
DOTFILES=(.gitconfig .gitignore_global .vimrc .zshrc .config/starship.toml .config/containers/containers.conf .config/mako/config .local/share/com.pais.handy/settings_store.json)
