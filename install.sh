...
DOTFILES=(.gitconfig .gitignore_global .vimrc .zshrc .config/starship.toml .config/containers/containers.conf .config/hyprwhspr/config.json .config/mako/config)
